  ...
  if(isset($_POST['calc'])){
      ...
      if(!$checkEmpty){
        ...
        if(!$checkNumeric){
          ...
          $irr=round(irr($cashFlow,$solutionCost),1)*100;
    ...
    <div class="wrapper container">
      ...
      <div class="wrapper-faq">
        <div class="nthFaq">
          ...
          <p>We provide a warranty of 2 years from the date of the first operation.</p>
          <div class="downGrey">
            <img src="images/downGrey.png" alt="image">
          </div>
  ...
  <div id="main" class="container">
    <div id="video" class="container">
      ...
      <div class="intro">
        ...
        <p> No Water Needed </p>
        <p> ROI in less than 12 months </p>
      </div>
      ...
      <div class="input container-fluid">
        <div class="mainWrapper container">
          ...
          <div class=" wrapper  col-md-6">
            ...
            <input class="userInput" type="text" value="3" name="nc"/>
          </div>
          <div class="wrapper col-md-6 ">
            <p class="attribute">Cost of cleaning(INR per module)</p>
            <input class="userInput" type="text" value="4" name="cc"/>
          </div>
          <div class="wrapper col-md-6">
            <p class="attribute">Average monthly generation loss(%)</p>
            <input class="userInput" type="text" value="4" name="mgl"/>
          </div>
          <div class="wrapper col-md-6 ">
            <p class="attribute">tariff(INR/KWp)</p>
            <input class="userInput" type="text" value="3" name="tariff"/>
          </div>
          <div class="wrapper col-md-6">
            <p class="attribute">Plant Size(Killo-Watts)</p>
            <input class="userInput" type="text" value="500" name="size"/>
          </div>
          <div class="wrapper col-md-6">
            <p class="attribute">No. of independent rows</p>
            <input class="userInput" type="text" value="24" name="nRows"/>
          </div>
          <div class="wrapper col-md-6 ">
            <p class="attribute">Solar Panel Capacity(Watts)</p>
            <input class="userInput" type="text" value="325" name="panelC"/>
          </div>
          <div class="wrapper col-md-6">
            <p class="attribute">Sunshine hours in a day(hours)</p>
            <input class="userInput" type="text" value="7" name="sunD"/>
          </div>
          <div class="wrapper col-md-6 ">
            <p class="attribute">Days of sunshine in an year(days)</p>
            <input class="userInput" type="text" value="300" name="sunY"/>
          </div>
  ...
  <div id="footer" class="footer container-fluid">
    <div class="footWrapper container">
      ...
      <div class="media col-xs-6 col-sm-6 col-md-6 col-lg-3">
        <div class="brand">
          <a href="index.html"><img src="images/jetsons.png" alt="jetsons"></a>
          <a href="index.html"><h4>Jetsons Robotics</h4></a>
        </div>
        <div class="social">
